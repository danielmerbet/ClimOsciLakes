...
#my_colors <- c(brewer.pal(n = 11, name = 'PuOr')[10], #violeta
#               pal_jco()(10)[c(6,1,5)], #azul
#               
#               brewer.pal(n = 8, name = 'Dark2')[c(1,5)],
#               pal_jco()(10)[c(7)], #verde
#               pal_jco()(10)[c(2)], 
#               brewer.pal(n = 8, name = 'Dark2')[c(6,2)], #amarillo
               
               #pal_jco()(10)[c(4,9)],
#               pal_jco()(10)[c(4)],
#               brewer.pal(n = 8, name = 'Dark2')[4],
#               wes_palette("GrandBudapest1")[3], #brown
#               "black",
               #wes_palette("BottleRocket1")[c(5)], #dark brown
#               "gray")


#my_colors <- c(brewer.pal(n = (length(factor_plot)-1), name = 'RdBu'),
#               "gray")

#my_colors <- c(colorRampPalette(c("#67001F","lightcoral",
#                                  "lightblue","#053061"))(length(factor_plot)-1), "gray")
...
#save plot  
ggsave(filename = "plot/plot1/fig1.pdf", plot = p1, width = 20, height = 10, units = "cm", dpi=300)  
#ggsave(filename = "plot/plot1/fig1_l.pdf", plot = p1, width = 20, height = 10, units = "cm", dpi=300)  
